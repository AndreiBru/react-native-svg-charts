...
This is a copy of the official `react-native-svg-charts` library (docs below), with the peerDependencies updated to avoid possibly running into legacy peer dependency issues.
